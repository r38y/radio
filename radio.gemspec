...
Gem::Specification.new do |s|
  ...
  s.files = ["History.txt", "Rakefile", "README.textile", "lib", "lib/radio.rb", "lib/radio", "lib/radio/string.rb", "script", "script/console", "test", "test/test_helper.rb", "test/test_radio.rb", "bin", "bin/radioize"]
  s.has_rdoc = false
